...
def _build_query_xml(
    ...
    FIXED: Removed Deviation.Id as it doesn't exist in the API schema!
    """
...
<REQUEST>
  ...
  <QUERY objecttype="Situation" schemaversion="1.2" limit="{limit}"
...
{filters}
    ...
    <!-- REMOVED: <INCLUDE>Deviation.Id</INCLUDE> - This field doesn't exist! -->
